// Pure formatting / aggregation helpers. No React, no I/O.
// These are split out of `queryKeys.ts` so the file name matches the contents.
...
export function setVolume(
  sets: Array<{ reps?: number | null; weight?: number | null; completed?: boolean | null }>,
): number {
